  ...
  <div class="container">
    ...
    <div class="grid">
      <div class="card" style="text-align:center;">
        ...
        <a href="{{ '/products/microgrids/' | relative_url }}" style="display:inline-block;margin-top:1rem;color:var(--brand);font-weight:600;text-decoration:none;">Learn More →</a>
      </div>
      <div class="card" style="text-align:center;">
        ...
        <a href="{{ '/products/converters/' | relative_url }}" style="display:inline-block;margin-top:1rem;color:var(--brand);font-weight:600;text-decoration:none;">Learn More →</a>
      </div>
      <div class="card" style="text-align:center;">
        ...
        <a href="{{ '/products/devices/' | relative_url }}" style="display:inline-block;margin-top:1rem;color:var(--brand);font-weight:600;text-decoration:none;">Learn More →</a>
      </div>
    </div>
  </div>
</section>
